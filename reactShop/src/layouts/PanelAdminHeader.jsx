      ...
      <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
          ...
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <div className="flex items-center justify-between gap-4">
              <a href="javascript:void(0)">
                <h4 className="text-xl font-bold text-pink-800">  پنل مدیریت فروشگاه  </h4>
              </a>
            </div>
        ...
        <div
          ...
          >
            ...
            {title.map((item)=>{
            return <li className="text-gray-600  flex items-center justify-center gap-2 hover:bg-slate-300 w-34 p-2 h-8 hover:text-pink-600 rounded-xl" >
