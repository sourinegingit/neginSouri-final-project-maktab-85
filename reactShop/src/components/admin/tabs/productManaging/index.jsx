...
const ProductManaging = () => {
  ...
  return (
    <div>
      <div>
        <div className="flex justify-between items-center text-pink-800  text-xl w-[70%] m-auto overflow-y-hidden ">
          <p>مدیریت کالاها</p>

          <div className="modal-container relative">
            <button
              onClick={HandleModal}
              className="py-2 px-14 text-center mr-16  mt-8 text-sm 
            ...
            <div className="modal w-[30vw] p-4 bg-gray-100 shadow-2xl rounded-lg   space-y-9 ">
              <div className="modal-header space-y-4 ">
                <div className="flex justify-between ">
                  <p className="text-[1.5rem] font-bold text-pink-800 mt-8">
                    افزودن/ویرایش کالا
                  </p>
                    ...
                    <div>
                      ...
                      <div className="">
                        <input
                          type="file"
                          id="img"
                          className="block p-2 w-full mb-10 text-xs text-pink-900 border border-pink-300
        ...
        <div className="w-[70%] relative overflow-x-auto shadow-xl sm:rounded-lg dir-rtl m-auto mt-5">
                ...
                return (
                  <tr className="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    <td className="px-6 py-4 ">
                      <img src={item.image[0]} height="40px" width="40px" />
                    </td>
                    <td className="px-6 py-4">{item.name}</td>
                    <td className="px-6 py-4">{item.category} تومان </td>
      ...
      <div className="mt-10 flex justify-center
       items-center text-white">
        <ReactPaginate
          className="pagination  flex gap-4 
          flex-row-reverse  bg-pink-600 rounded-lg p-2"
          breakLabel="..."
          nextLabel="<بعد "
